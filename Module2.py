...
class user_interface(Frame):
    ...
    def __init__(self, root):
        ...
        # self.author = Label(root, text="By - Kamlesh Pandey @ 2019", font="Times 12 bold")
        ...
        self.vvar = IntVar()
        self.svar = IntVar()
        self.hBlur = Checkbutton(self.root, text="Horizontal Blur", variable=self.hvar).place(x=480, y=240)
        self.vBlur = Checkbutton(self.root, text="Vertical Blur", variable=self.vvar).place(x=480, y=270)
        self.sharp = Checkbutton(self.root, text="Sharpness", variable=self.svar).place(x=480, y=300)
